...
def test_create_user():
    payload = {"first_name": "Test", "last_name": "Agent", "contact_email": "agent@test.com", "role": "admin"}
...
def test_get_users():
    ...
    response = client.get("/api/v2/users", headers={"x-api-version": "0.1.0"})
...
def test_get_user_by_id():
    ...
    create_resp = client.post("/api/v2/users", json={"first_name": "Bob", "last_name": "Builder", "contact_email": "bob@test.com", "role": "worker"}, headers={"x-api-version": "0.1.0"})
